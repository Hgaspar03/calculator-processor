...
RabbitTemplate tamplete;
	...
	public String consumeMessageFromQueue(Calculation calc){
        ...
        logger.info("Executando o calculo {} com ID: {} ", calc, calc.getCalculationId());
		...
		logger.info("calculo {}, teve o resultado {} com ID: {}", calc, calc.getResult(), calc.getCalculationId());
